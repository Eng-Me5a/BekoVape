...
const API_URL = process.env.REACT_APP_API_URL || "https://beko-vape-server-production.up.railway.app/api";
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch("https://beko-vape-server-production.up.railway.app/api/orders", {
          headers: {
  ...
  const updateOrderStatus = async (
    ...
    try {
      ...
      const response = await fetch(
        `https://beko-vape-server-production.up.railway.app/api/orders/${orderId}`,
        {
          method: "PATCH",
          headers: {
